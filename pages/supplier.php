                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title" id="myModalLabel">Thêm nhà cung cấpr</h4>
                                    </div>
                                    <div class="modal-body">

                                     <form action="savesupplier.php" method="post" class = "form-group">
                                        <div id="ac">
                                            <span>Tên nhà cung cấp : </span><input type="text" name="name" class = "form-control" />
                                            <span>Liên hệ cá nhân : </span><input type="text" name="cperson" class = "form-control" />
                                            <span>Đại chỉ : </span><input type="text" name="address" class = "form-control" />
