    ...
    <div id="page-wrapper">
        <div class="row">
            ...
            <div id="maintable"><div style="margin-top: -19px; margin-bottom: 21px;">
             ...
             <a  href = "#add" data-toggle = "modal" class="btn btn-primary">Thêm sản phẩm</a>
                    ...
                    <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th> Giá bán </th>
                                <th> Nhà cung cấp </th>
                                <th witdh = "10%"> Số lượng còn lại </th>
                                <th witdh = "10%"> Đơn vị tính </th>
                                <th> Hoạt động </th>
                            </tr>
                        </thead>
                        <tbody>
                    ...
                    <a href="" onclick="window.print()" class="btn btn-primary"><i class="icon-print icon-large"></i> In</a>
